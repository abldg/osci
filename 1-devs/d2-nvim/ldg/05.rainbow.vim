...
" FLENAME: 05.rainbow.vim
" CONTACT: developer@huachen.link
" CREATED: 2023-02-05 23:52:41
" LTSVERN: 0.1
" LTSUPDT: 2023-02-05 23:52:41
"=====================================================================
"==============================================================================
...
command! RainbowToggle call RainBow_toggle()
command! RainbowToggleOn call RainBow_hook()
command! RainbowToggleOff call RainBow_clear()

if (exists('g:rainbow_active') && g:rainbow_active)
	auto syntax * call RainBow_hook()
	auto colorscheme * call RainBow_show()
endif
